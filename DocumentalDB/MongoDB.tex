...
\subsection{Query 11}
This query returns all the articles written by authors that combined have all 26 letters of the alphabet.
\begin{lstlisting}
db.authors.aggregate([
	{
