...
In our queries, we decided not to use indexes because they weren't necessary to achieve a good performance score. Instead, in bigger and
real world databases, could be helpful to create textual indexes on both the collections, in order to perform full-text search
on some fields.
