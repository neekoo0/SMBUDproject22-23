...
\begin{enumerate}
    ...
    \item Create \emph{Field of Study} and \verb |REGARD| relationship between \emph{Field of Study} and \emph{Publication}: \lstinputlisting[language=SQL]{Code/import/imp6.txt}
...
\lstinputlisting[language=SQL]{Code/commands/cmd1.txt}
...
\lstinputlisting[language=SQL]{Code/commands/cmd2.txt}
...
\lstinputlisting[language=SQL]{Code/commands/cmd3.txt}
...
\lstinputlisting[language=SQL]{Code/commands/cmd4.txt}
...
\lstinputlisting[language=SQL]{Code/commands/cmd5.txt}
...
\lstinputlisting[language=SQL]{Code/commands/cmd6.txt}
