...
\begin{itemize}
    ...
    \item \textbf{Publishes} links \emph{Publications} with the \emph{Venues} in which it was published
    \item \textbf{Regards} links \emph{Publications} with the covered \emph{Fields of Study}
    \item \textbf{Mentions} links a \emph{Publication} with another one cited
\end{itemize}
\bigskip
...
while the other one was published in a journal. At the end we have to say that exists a relationship \emph{Mentions} that
...
\caption{Results: 6 records after 1 ms and completed after 44 ms}
\label{fig:query1}
\end{figure}
...
\caption{Results: 1 records after 1 ms and completed after 24 ms}
\label{fig:query2}
\end{figure}
...
\caption{Results: 526 records after 2 ms and completed after 948 ms}
\label{fig:query3}
\end{figure}
...
\caption{Results: 18 records after 29 ms and completed after 1264 ms}
\label{fig:query4}
\end{figure}
...
\caption{Results: 1 records after 1 ms and completed after 158 ms}
\label{fig:query5}
\end{figure}
...
\caption{Results: 4 records after 1 ms and completed after 27 ms}
\label{fig:query7}
\end{figure}
...
\caption{Results: 2 records after 1 ms and completed after 31 ms}
\label{fig:query8}
\end{figure}
...
\caption{Results: 1 records in less than 1 ms and completed after 44 ms}
\label{fig:query9}
\end{figure}
...
\caption{Results: 1 records after 1 ms and completed after 31 ms}
\label{fig:query11}
\end{figure}
